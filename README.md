...
<table>
  <tr>
    <td>
      <figure>
        <figcaption>Построение одной башенки</figcaption>
...
В представленном ниже видео наглядно показана работа системы стабилизации(во избежание чрезвычайно ситуации человек лишь слега придерживает коптер). 
